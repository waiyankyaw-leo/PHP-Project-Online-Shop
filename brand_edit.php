...
?>
    <div class="app-title">
        <div>
            <h1> <i class="icofont-list"></i> Brand Edits</h1>
        </div>
            ...
            <div class="tile">
                <div class="tile-body">
                    <form action="brand_update.php" method="POST" enctype="multipart/form-data">
                        ...
                        <input type="hidden" name="oldprofile" value="<?= $brands['photo']?>">
                        ...
                        <div class="tab-content" id="nav-tabContent">
                          <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab"><img src="<?= $brands['photo'] ?>" id="showOldphoto" class="img-fluid" style="width: 300px; height:200px"></div>
